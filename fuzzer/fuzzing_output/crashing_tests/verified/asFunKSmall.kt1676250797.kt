...
inline fun asFailsWithCCE(operation: (String)?, block: (() -> Unit)): Unit {
try {
block()
...
inline fun asSucceeds(operation: String, block: (() -> Unit)): (Unit)? {
try {
block()
}catch(e: Throwable) {
...
fun box(): String {
val f0 = (::fn0 as Any)
val f1 = ((((if ((((::fn1) != null) ?: ((::fn1) != null))) {
(::fn1)
} else {
(::fn1)
})) ?: ((if ((((::fn1) != null) ?: ((::fn1) != null))) {
(::fn1)
} else {
(::fn1)
}))) as Any)
