...
if (ann.i != 2) {
return "fail: annotation parameter i should be 2, but was ${ann.i}"
}
if (ann.s != 2.toShort()) {
return "fail: annotation parameter i should be 2, but was ${ann.i}"
}
...
if ((! ann.Foo)) {
return "fail: annotation parameter i should be true, but was ${ann.i}"
}
if (ann.c != 'c') {
return "fail: annotation parameter i should be c, but was ${ann.i}"
}
if (ann.str != "str") {
return "fail: annotation parameter i should be str, but was ${ann.i}"
}
return "OK"
}
