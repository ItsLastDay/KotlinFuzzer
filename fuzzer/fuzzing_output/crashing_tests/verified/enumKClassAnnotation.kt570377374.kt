...
fun box(): String {
val a1 = Anno::class.constructors.single().call(DeprecationLevel.WARNING, (Number)?::class, Foo::class.constructors.single().call("OK"), arrayOf(DeprecationLevel.WARNING), arrayOf(Number::class), arrayOf(Foo::class.constructors.single().call("OK")))
