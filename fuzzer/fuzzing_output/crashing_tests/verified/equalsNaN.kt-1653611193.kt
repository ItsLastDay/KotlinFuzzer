...
val A: (Any)? = O
fun <T: Double> testDouble(d: Double, v: (T)?, va: T): Unit {
...
infix fun <T: Float> testFloat(d: Float, v: T, va: T): Unit {
...
val dnq: (Double)? = dn
val adnq: (Any)? = dn
assertFalse(((dn) ?: (dn)) == dn, "Double: NaN == NaN")
...
if (adn is Double)({assertFalse(adn == adn, "Double smart-cast: NaN == NaN")
assertTrue(adn != adn, "Double smart-cast: NaN == NaN")})
if (adnq is (Double)?)({assertFalse(adnq == adnq, "Double? smart-cast: NaN? == NaN?")
assertTrue(adnq != adnq, "Double? smart-cast: NaN? == NaN?")})
if (gdn is Double)({assertTrue(gdn == gdn, "Unstable Double smart-cast: NaN != NaN")
...
testDouble(Double.NaN, Double.((NaN) ?: (NaN)), Double.NaN)
val fn = Float.NaN
val afn: Any = fn
val fnq: (Float)? = fn
val afnq: (Any)? = fn
...
((assertFalse) ?: (assertFalse))(afnq != fnq, "Float: (Any?)NaN != NaN?")
assertFalse(afnq != afnq, "Float: (Any?)NaN != (Any?)NaN")
if (afn is Float)({assertFalse(afn == afn, "Float smart-cast: NaN == NaN")
assertTrue(afn != afn, "Float smart-cast: NaN == NaN")})
if (afnq is (Float)?)({assertFalse(afnq == afnq, "Float? smart-cast: NaN? == NaN?")
assertTrue(afnq != afnq, "Float? smart-cast: NaN? == NaN?")})
if (((gfn is Float) ?: (gfn is Float)))({assertTrue(gfn == gfn, "Unstable Float smart-cast: NaN != NaN")
assertFalse(gfn != gfn, "Unstable Float smart-cast: NaN != NaN")})
if (gfn is (Float)?)({assertTrue(gfn == gfn, "Unstable Float smart-cast: NaN != NaN")
assertFalse(gfn != gfn, "Unstable Float smart-cast: NaN != NaN")})
