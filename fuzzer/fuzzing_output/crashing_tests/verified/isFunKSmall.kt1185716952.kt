...
val eps = (when {
(((Any::extProp) ?: (Any::extProp))) != null -> (((Any::extProp) ?: (Any::extProp)))
else -> (((Any::extProp) ?: (Any::extProp)))
}).setter
val afoo = A::foo
fun local0(): Unit {

}
fun local1(x: (Any)?): Unit {

}
val Unit.localFun0 = (::local0 as Any)
...
assert(((eps) ?: (eps)) is Function2<*, *, *>)({"Failed: eps is Function2<*, *, *>"})
