...
fun assertGenericType(type: KType): Unit {
val javaType = type.javaType
if (javaType !is ParameterizedType)({throw AssertionError("Type should be a parameterized type, but was $javaType (${javaType.javaClass})")})
}
fun box(): String {
