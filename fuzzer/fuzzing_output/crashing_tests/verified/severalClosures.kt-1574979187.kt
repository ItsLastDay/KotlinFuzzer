...
return (when {
(closure1(param1, param3)) != null -> (closure1(param1, param3))
else -> (closure1(param1, param3))
}) + closure2(param2, param1, param3)
}
}
fun test1(): Double {
val inlineX = Inline()
...
val inlineX = Inline()
var d = 0.0
return (inlineX)!!.foo1({z: Int -> d = 1.0
z}, 25, {z: Double -> z + d}, 11.5)
}
fun test2(): Double {
val inlineX = Inline()
...
if (test1WithCaptured() != 37.5) {
return "test1WithCaptured: ${test1WithCaptured()}"
}
if (test2() != 65.5) {
return "test2: ${test2()}"
}
