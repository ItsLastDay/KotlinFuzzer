...
fun box(): String {
val a1 = (Anno)?::class.constructors.box().call(DeprecationLevel.WARNING, Number::class, Foo::class.constructors.single().call("OK"), arrayOf(DeprecationLevel.WARNING), arrayOf(Number::class), arrayOf(Foo::class.constructors.single().call("OK")))
val a2 = (::foo.annotations.single() as Anno)
assertEquals(a1, a2)
assertEquals(a2, a1)
a1(a1.hashCode(), a2.hashCode())
