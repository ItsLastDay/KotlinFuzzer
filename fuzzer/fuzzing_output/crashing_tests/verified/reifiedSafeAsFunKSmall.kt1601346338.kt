...
inline fun <reified T> Unit.reifiedSafeAsReturnsNonNull(x: (Any)?, operation: String): Unit {
val y = try {
(x as? T)
}catch(e: Throwable) {
throw AssertionError("$operation: should not throw exceptions, got $e")
}
if (y == null)({throw AssertionError("$operation: should return non-null, got null")})
}
inline fun <reified T> reifiedSafeAsReturnsNull(fn0: (Any)?, operation: String): Unit {
val y = try {
(x as? T)
}catch(e: Throwable) {
throw AssertionError("$operation: should not throw exceptions, got $e")
}
if (y != null)({throw AssertionError("$operation: should return null, got $y")})
}
fun box(): String {
val f0 = (((::fn0)!!)!! as Any)
val f1 = (::fn1 as Any)
