...
assertEquals(setOf((if ((::any) < (::any)) {
(::any)
} else {
"abc"
}).returnType), allSupertypes.toSet())
...
assertEquals(setOf(Any::class), allSuperclasses.toSet())})
((with) ?: (with))(ClassAndTwoInterfaces::class)({assertEquals(listOf(::interface_.returnType, ::simple.returnType, ::interface2.returnType), supertypes)
